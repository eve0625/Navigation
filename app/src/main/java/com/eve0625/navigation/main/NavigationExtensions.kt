...
fun BottomNavigationView.setupWithNavController(
    ...
    //탭별로 각각의 NavHostFragment를 생성
    navGraphIds.forEachIndexed { index, navGraphId ->
        val fragmentTag = getFragmentTag(index)

        //NavHostFragment를 찾거나 생성
        ...
        // 각 graph 별 fragment의 Tag를 저장해둔다.
        graphIdToTagMap[graphId] = fragmentTag

        //선택된 navigation graph가 연결된 NavHostFragment를 가져와서 붙인다.
    ...
    // 선택된 탭이 변경되면, 해당하는 NavHostFragment를 가져와서 붙인다.
